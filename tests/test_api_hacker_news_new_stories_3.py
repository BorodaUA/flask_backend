...
# def test_hn_patch_newstories_comments_required_fields_empty(client):
#     """
...
# def test_hn_patch_newstories_comments_required_fields_valid(client):
#     """
#     test PATCH /api/hackernews/newstories/<story_id>/comments
...
# def test_api_hn_delete_newstories_comments_invalid_story_id(client):
#     """
...
# def test_api_hn_delete_newstories_comments_valid_data_2_times(client):
#     """
#     test DELETE /api/hackernews/newstories/<story_id>/comments/<comment_id>
#     with valid <story_id>, valid <comment_id>, 2 times in a row
#     """
#     insert_in_table(
#         insert_data=test_row,
#         db_address=os.environ.get('TEST_HACKER_NEWS_DATABASE_URI'),
