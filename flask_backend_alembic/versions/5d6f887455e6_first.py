...
Revision ID: 5d6f887455e6
Revises: 
Create Date: 2020-08-02 22:13:49.021543
...
def upgrade():
    ...
    op.create_table(
        "blog_news_stories_comments",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
        sa.Column("parse_dt", sa.DateTime(), nullable=True),
        sa.Column("by", sa.String(), nullable=True),
        sa.Column("deleted", sa.Boolean(), nullable=True),
        ...
        sa.Column("origin", sa.String(length=128), nullable=False),
        sa.ForeignKeyConstraint(["parent"], ["blog_news_stories.id"],),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_table(
        "users",
...
def downgrade():
    ...
    op.drop_table("users")
    op.drop_table("blog_news_stories_comments")
    op.drop_table("blog_news_stories")
    # ### end Alembic commands ###
